...
export const TALENTS: Record<string, TalentDef> = {
  ...
  "animal:kodiak-bear":      { id: "rapport-force", family: "oracle",   name: "Le Rapport de Force", description: "L'ours ne compte pas ce qu'il soulève — il compte ce qu'il pèse. Concrètement : débloque la salle « Le Rapport de Force » dans l'Oracle : pour chaque exercice, ta meilleure charge rapportée à ton poids de corps (×1,07, ×0,85…), classée du plus fier au plus discret.", effect: FEATURE },
